...
if (!buildJs.includes("version: 284") || !appJs.includes("RTDB_WRITE_PROTOCOL_V279 = 279") || !indexHtml.includes("build.js?v=284") || !indexHtml.includes("app.js?v=283") || !indexHtml.includes("app.css?v=284") || !indexHtml.includes("operator-mobile.css?v=284")) fail("v284 build/CSS assets, unchanged v283 app asset, and v279 server-enforced write protocol markers must stay aligned.");
