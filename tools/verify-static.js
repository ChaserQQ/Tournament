...
if (!buildJs.includes("version: 283") || !appJs.includes("RTDB_WRITE_PROTOCOL_V279 = 279") || !indexHtml.includes("app.js?v=283") || !indexHtml.includes("app.css?v=283") || !indexHtml.includes("operator-mobile.css?v=283")) fail("v283 build/assets and v279 server-enforced write protocol markers must stay aligned.");
...
if (!appCss.includes("v283: empty LIVE slots") || !operatorMobileCss.includes("grid-template-rows: 44px") || !surfaceQa.includes("compactEmptySlots") || !operatorQa.includes("operator mobile dock buttons must be 44px")) fail("v283 compact LIVE lobby and 44px mobile control contracts must stay covered by CSS and QA.");
