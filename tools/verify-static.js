...
if (!buildJs.includes("version: 285") || !appJs.includes("RTDB_WRITE_PROTOCOL_V279 = 279") || !indexHtml.includes("build.js?v=285") || !indexHtml.includes("app.js?v=285") || !indexHtml.includes("app.css?v=284") || !indexHtml.includes("operator-mobile.css?v=285")) fail("v285 build/app/operator-mobile assets, unchanged v284 shared CSS asset, and v279 server-enforced write protocol markers must stay aligned.");
