...
if (!buildJs.includes("version: 287") || !appJs.includes("RTDB_WRITE_PROTOCOL_V279 = 279") || !indexHtml.includes("build.js?v=287") || !indexHtml.includes("app.js?v=287") || !indexHtml.includes("app.css?v=284") || !indexHtml.includes("operator-mobile.css?v=285")) fail("v287 build/app assets, unchanged v284 shared CSS and v285 operator-mobile CSS assets, and v279 server-enforced write protocol markers must stay aligned.");
