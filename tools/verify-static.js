...
if (!buildJs.includes("version: 286") || !appJs.includes("RTDB_WRITE_PROTOCOL_V279 = 279") || !indexHtml.includes("build.js?v=286") || !indexHtml.includes("app.js?v=286") || !indexHtml.includes("app.css?v=284") || !indexHtml.includes("operator-mobile.css?v=285")) fail("v286 build/app assets, unchanged v284 shared CSS and v285 operator-mobile CSS assets, and v279 server-enforced write protocol markers must stay aligned.");
