...
if (!buildJs.includes("version: 280") || !appJs.includes("RTDB_WRITE_PROTOCOL_V279 = 279") || !indexHtml.includes("app.js?v=280")) fail("v280 build and v279 server-enforced write protocol markers must stay aligned.");
