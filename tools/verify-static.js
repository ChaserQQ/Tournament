...
if (!buildJs.includes("version: 281") || !appJs.includes("RTDB_WRITE_PROTOCOL_V279 = 279") || !indexHtml.includes("app.js?v=281")) fail("v281 build and v279 server-enforced write protocol markers must stay aligned.");
