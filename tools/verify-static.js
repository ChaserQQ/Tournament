...
if (!buildJs.includes("version: 282") || !appJs.includes("RTDB_WRITE_PROTOCOL_V279 = 279") || !indexHtml.includes("app.js?v=282")) fail("v282 build and v279 server-enforced write protocol markers must stay aligned.");
